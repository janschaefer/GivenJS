...
function withoutNull( array ) {
    return _.filter( array, function (x) { return x !== null; });
}
...
function analyseScenario( scenarioModel ) {
    ...
    var names = _.map( differentParams, function(word) { return word.argumentInfo.argumentName; });
